...
public class RetrieveEvent extends AsyncTask<String, String, TCPClient> {

    private final String TAG = "RetrieveEvent";
    private TCPClient tcpClient;
    private Handler mHandler;
/*
    // mHandler is used to update UI
    public RetrieveEvent(Handler mHandler) {
...
*/
    ...
    protected TCPClient doInBackground(String... params) {
        ...
        try {
            tcpClient = new TCPClient(mHandler, params[0],
